...
class Commands {
  ...
  init(){
    this.command.list = [
      ...
      new Gif("comandos gif: ", "usa Gifs nwn  upf!kiss, upf!bye, upf!dance, upf!happy, upf!sad, upf!kill, upf!hug, upf!elcomandonoexiste, upf!sleep, upf!hi, upf!angry, upf!confused, upf!revive, upf!cry"),
      ...
      new SaveLink("saveLink", "upf!saveLink LINK  guarda un link, upf!saveLink delete NUMBER borra un comando , upf!saveLink update recarga,  upf!saveLink random  da un link random ^^"),
      new Pmessage("pmessage", "envia un mensaje privado o-o upf!pmessage @mention /mensaje"),
